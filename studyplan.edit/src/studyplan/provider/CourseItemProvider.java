...
public class CourseItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTaughtInAutumnPropertyDescriptor(object);
			addTaughtInSpringPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.COURSE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.COURSE__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.COURSE__LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.COURSE__CREDITS,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Taught In Autumn feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaughtInAutumnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_taughtInAutumn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_taughtInAutumn_feature", "_UI_Course_type"),
				 StudyplanPackage.Literals.COURSE__TAUGHT_IN_AUTUMN,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Taught In Spring feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaughtInSpringPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Course_taughtInSpring_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Course_taughtInSpring_feature", "_UI_Course_type"),
				 StudyplanPackage.Literals.COURSE__TAUGHT_IN_SPRING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
