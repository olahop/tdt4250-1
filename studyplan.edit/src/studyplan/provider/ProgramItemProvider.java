...
/**
 * This is the item provider adapter for a {@link studyplan.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.PROGRAM__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addMandatoryCoursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_mandatoryCourses_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_mandatoryCourses_feature", "_UI_Program_type"),
				 StudyplanPackage.Literals.PROGRAM__MANDATORY_COURSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyplanPackage.Literals.PROGRAM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyplanPackage.Literals.PROGRAM__SPECIALIZATIONS);
			childrenFeatures.add(StudyplanPackage.Literals.PROGRAM__SEMESTERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyplanPackage.Literals.PROGRAM__SPECIALIZATIONS,
				 StudyplanFactory.eINSTANCE.createSpecialization()));

		newChildDescriptors.add
			(createChildParameter
				(StudyplanPackage.Literals.PROGRAM__SEMESTERS,
