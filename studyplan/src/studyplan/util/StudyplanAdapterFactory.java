...
public class StudyplanAdapterFactory extends AdapterFactoryImpl {
	...
	protected StudyplanSwitch<Adapter> modelSwitch =
		new StudyplanSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSemesterOptionalCourseGroup(SemesterOptionalCourseGroup object) {
				return createSemesterOptionalCourseGroupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link studyplan.SemesterOptionalCourseGroup <em>Semester Optional Course Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link studyplan.Studyplan <em>Studyplan</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
